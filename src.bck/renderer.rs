...
impl Renderer {
    ...
    pub fn push_light(&mut self, light: DrawLight) {
...
impl DrawPrimitive {
    ...
    pub fn world_rect(rect: Rect, color: Color) -> Self {
        Self {
            z: 0.0,
            rect,
            space: SpaceType::WorldSpace,
...
impl Color {
    ...
    pub fn from_rgba(arr: &[f32; 4]) -> Self {
